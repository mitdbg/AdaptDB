...
OPTIONS (path "/user/mdindex/tpch100/part.tbl.1,/user/mdindex/tpch100/part.tbl.2,/user/mdindex/tpch100/part.tbl.3,/user/mdindex/tpch100/part.tbl.4,/user/mdindex/tpch100/part.tbl.5,/user/mdindex/tpch100/part.tbl.6,/user/mdindex/tpch100/part.tbl.7,/user/mdindex/tpch100/part.tbl.8,/user/mdindex/tpch100/part.tbl.9,/user/mdindex/tpch100/part.tbl.10", header "false", delimiter "|")""")
...
USING com.databricks.spark.csv
OPTIONS (path "/user/mdindex/tpch100/supplier.tbl.1,/user/mdindex/tpch100/supplier.tbl.2,/user/mdindex/tpch100/supplier.tbl.3,/user/mdindex/tpch100/supplier.tbl.4,/user/mdindex/tpch100/supplier.tbl.5,/user/mdindex/tpch100/supplier.tbl.6,/user/mdindex/tpch100/supplier.tbl.7,/user/mdindex/tpch100/supplier.tbl.8,/user/mdindex/tpch100/supplier.tbl.9,/user/mdindex/tpch100/supplier.tbl.10", header "false", delimiter "|")""")
...
USING com.databricks.spark.csv
OPTIONS (path "/user/mdindex/tpch100/customer.tbl.1,/user/mdindex/tpch100/customer.tbl.2,/user/mdindex/tpch100/customer.tbl.3,/user/mdindex/tpch100/customer.tbl.4,/user/mdindex/tpch100/customer.tbl.5,/user/mdindex/tpch100/customer.tbl.6,/user/mdindex/tpch100/customer.tbl.7,/user/mdindex/tpch100/customer.tbl.8,/user/mdindex/tpch100/customer.tbl.9,/user/mdindex/tpch100/customer.tbl.10", header "false", delimiter "|")""")
...
USING com.databricks.spark.csv
OPTIONS (path "/user/mdindex/tpch100/orders.tbl.1,/user/mdindex/tpch100/orders.tbl.2,/user/mdindex/tpch100/orders.tbl.3,/user/mdindex/tpch100/orders.tbl.4,/user/mdindex/tpch100/orders.tbl.5,/user/mdindex/tpch100/orders.tbl.6,/user/mdindex/tpch100/orders.tbl.7,/user/mdindex/tpch100/orders.tbl.8,/user/mdindex/tpch100/orders.tbl.9,/user/mdindex/tpch100/orders.tbl.10", header "false", delimiter "|")""")
...
USING com.databricks.spark.csv
OPTIONS (path "/user/mdindex/tpch100/lineitem.tbl.1,/user/mdindex/tpch100/lineitem.tbl.2,/user/mdindex/tpch100/lineitem.tbl.3,/user/mdindex/tpch100/lineitem.tbl.4,/user/mdindex/tpch100/lineitem.tbl.5,/user/mdindex/tpch100/lineitem.tbl.6,/user/mdindex/tpch100/lineitem.tbl.7,/user/mdindex/tpch100/lineitem.tbl.8,/user/mdindex/tpch100/lineitem.tbl.9,/user/mdindex/tpch100/lineitem.tbl.10", header "false", delimiter "|")""")

// Create nation table.
sqlContext.sql(s"""CREATE TEMPORARY TABLE nation (n_nationkey int, n_name string, n_regionkey int,
	n_comment string)
USING com.databricks.spark.csv
OPTIONS (path "/user/mdindex/tpch100/nation.tbl", header "false", delimiter "|")""")

// Create region table.
sqlContext.sql(s"""CREATE TEMPORARY TABLE region (r_regionkey int, r_name string, r_comment string)
USING com.databricks.spark.csv
OPTIONS (path "/user/mdindex/tpch100/region.tbl", header "false", delimiter "|")""")
