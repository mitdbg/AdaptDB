...
public class SparkJoinQuery extends SparkQuery {
	...
	public JavaPairRDD<LongWritable, SparkJoinRecordReader.JoinTuplePair> createJoinRDD(
			boolean assignBuckets, String hdfsPath1, int rid1,
			int joinAttribute1, String hdfsPath2, int rid2, int joinAttribute2) {
		...
		ctx.hadoopConfiguration()
				.set("JOIN_CONDITION",
						rid1 + "." + joinAttribute1 + "=" + rid2 + "."
								+ joinAttribute2);
		ctx.hadoopConfiguration().set("HADOOP_NAMENODE",
				cfg.getHADOOP_NAMENODE());
	...
	// public static abstract class JoinFlatMapFunction<K,V> implements
	// FlatMapFunction<Iterator<Tuple2<LongWritable,IteratorRecord>>,
	// Tuple2<V,V>> {
	// private static final long serialVersionUID = 1L;
	// private SparkHashJoin<K,V> hj;
	// protected int rid1, rid2;
	// protected int joinAttribute1, joinAttribute2;
	// public JoinFlatMapFunction(int rid1, int joinAttribute1, int rid2, int
	// joinAttribute2){
	// this.rid1 = rid1;
	// this.rid2 = rid2;
	...
	// }
	// public Iterable<Tuple2<V,V>> call(Iterator<Tuple2<LongWritable,
	// IteratorRecord>> arg0) throws Exception {
	// // perform join
	...
	// }
	//
	// public static class StringStringJoin extends
	// JoinFlatMapFunction<String,String>{
	// private static final long serialVersionUID = 1L;
	// public StringStringJoin(int rid1, int joinAttribute1, int rid2, int
	// joinAttribute2) {
