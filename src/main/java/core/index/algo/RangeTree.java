...
//	}
	...
	/**
	 * Get the number of attributes that could be packed in the 
	 * tree, each with the given fanout and coverage.  
	 * 
	 * a = r/c.logf (D/P)
	 * 
	 * @param f - the fanout of the tree
	 * @param c	- the coverage of each attribute
	...
	public double getSlotsPerAttribute(int l){		
		...
		return x * ( Math.log((double)D/P)/Math.log(2) - l + 1) / ((double)A/r - x + 1);
	}
