...
public class ReusablePartition implements Cloneable, Serializable {
	...
	/*
	 * hack: currently the clone object is the standard Partition object, i.e.
	 * we do not support reusing for writing.
	 */
	...
	public boolean equals(Object p) {
		return ((ReusablePartition) p).path.equals(path)
				&& ((ReusablePartition) p).partitionId == partitionId;
	}
