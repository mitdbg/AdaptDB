...
fab setup:localjoin_orders create_table_info
fab setup:localjoin_orders bulk_sample_gen
fab setup:localjoin_orders create_robust_tree
fab setup:localjoin_orders write_partitions
