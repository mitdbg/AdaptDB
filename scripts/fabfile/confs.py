confs = {
        ...
        "tpch": {
            ...
            "local_lineitem" : {
                'JAR' : '/Users/ylu/Documents/workspace/mdindex/build/libs/mdindex-all.jar',
                'CONF' : '/Users/ylu/Documents/workspace/mdindex/conf/ylu.properties',
                'INPUTSDIR' : '/Users/ylu/Documents/workspace/mdindex/data/lineitem',
                'TABLENAME' : 'lineitem',
                ...
                'NUMTUPLES': '6001215',
                'NUMFIELDS' : '16',
                'SCHEMA': 'l_orderkey int, l_partkey int, l_suppkey int, l_linenumber int, l_quantity double, l_extendedprice double, l_discount double, l_tax double, l_returnflag string,  l_linestatus string, l_shipdate date, l_commitdate date, l_receiptdate date, l_shipinstruct string, l_shipmode string, l_comment string',
                'USER': 'ylu',
                'HOSTS': ['localhost'],
                'ROLEDEFS': { 'master': ['localhost'] }
                },
            "local_orders" : {
                'JAR' : '/Users/ylu/Documents/workspace/mdindex/build/libs/mdindex-all.jar',
                'CONF' : '/Users/ylu/Documents/workspace/mdindex/conf/ylu.properties',
                'INPUTSDIR' : '/Users/ylu/Documents/workspace/mdindex/data/orders',
                'TABLENAME' : 'orders',
                ...
                'NUMTUPLES': '1500000',
                'NUMFIELDS' : '9',
                'SCHEMA': 'o_orderkey int, o_custkey int, o_orderstatus string, o_totalprice double, o_orderdate date, o_orderpriority string, o_clerk string, o_shippriority int, o_comment string',
                'USER': 'ylu',
                'HOSTS': ['localhost'],
                'ROLEDEFS': { 'master': ['localhost'] }
                },
            "local_part" : {
                'JAR' : '/Users/ylu/Documents/workspace/mdindex/build/libs/mdindex-all.jar',
                'CONF' : '/Users/ylu/Documents/workspace/mdindex/conf/ylu.properties',
                'INPUTSDIR' : '/Users/ylu/Documents/workspace/mdindex/data/part',
                'TABLENAME' : 'part',
                ...
                'NUMTUPLES': '200000',
                'NUMFIELDS' : '9',
                'SCHEMA': 'p_partkey int, p_name string, p_mfgr string, p_brand string, p_type string, p_size int, p_container string, p_retailprice double, p_comment string',
                'USER': 'ylu',
                'HOSTS': ['localhost'],
                'ROLEDEFS': { 'master': ['localhost'] }
                },
             "local_supplier" : {
                'JAR' : '/Users/ylu/Documents/workspace/mdindex/build/libs/mdindex-all.jar',
                'CONF' : '/Users/ylu/Documents/workspace/mdindex/conf/ylu.properties',
                'INPUTSDIR' : '/Users/ylu/Documents/workspace/mdindex/data/supplier',
                'TABLENAME' : 'supplier',
                ...
                'NUMTUPLES': '10000',
                'NUMFIELDS' : '7',
                'SCHEMA': 's_suppkey int, s_name string, s_address string, s_nationkey int, s_phone string, s_acctbal double, s_comment string',
                'USER': 'ylu',
                'HOSTS': ['localhost'],
                'ROLEDEFS': { 'master': ['localhost'] }
                },
             "local_customer" : {
                'JAR' : '/Users/ylu/Documents/workspace/mdindex/build/libs/mdindex-all.jar',
                'CONF' : '/Users/ylu/Documents/workspace/mdindex/conf/ylu.properties',
                'INPUTSDIR' : '/Users/ylu/Documents/workspace/mdindex/data/customer',
                'TABLENAME' : 'customer',
                ...
                'NUMTUPLES': '150000',
                'NUMFIELDS' : '8',
                'SCHEMA': 'c_custkey int, c_name string, c_address string, c_nationkey int, c_phone string, c_acctbal double, c_mktsegment string , c_comment string',
                'USER': 'ylu',
                'HOSTS': ['localhost'],
                'ROLEDEFS': { 'master': ['localhost'] }
                }
