...
public class TypeUtils {
	...
	public static String getStringAttribute(String attr) {
		return attr;
	}

	public static int getIntAttribute(String attr) {
		return Integer.parseInt(attr);
	}

	public static long getLongAttribute(String attr) {
		return Long.parseLong(attr);
	}

	public static double getDoubleAttribute(String attr) {
     ...
     */
	public static TypeUtils.SimpleDate getDateAttribute(String attr) {
	 ...
	 *
	 */
	public static boolean getBooleanAttribute(String attr) {
